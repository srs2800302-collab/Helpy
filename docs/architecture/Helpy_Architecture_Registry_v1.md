...
- Полная переделка существующей системы водоотведения не входит в услугу установки измельчителя.
- Если для выполнения работ необходимы дополнительные материалы или комплектующие, применяется Global Materials Separation Rule.
...
1. Старая стиральная машина сейчас установлена на месте?
- Да.
- Нет.
...
1. Существующая посудомоечная машина сейчас установлена на месте?
- Да.
- Нет.
