...
Назначение:
- Этот mini-ТЗ описывает замену существующего кондиционера внутри категории Air Conditioning.
- Сценарий «Заменить» применяется, когда старый кондиционер уже установлен, а новый кондиционер находится на объекте клиента.
- Замена состоит из демонтажа установленного кондиционера и последующей установки и подключения нового кондиционера.
- В MVP поддерживается только замена на новый кондиционер.
- Установка бывших в эксплуатации или ранее демонтированных кондиционеров не входит в MVP.
- Сценарий «Заменить» не является ремонтом, переносом, диагностикой, ремонтом стены, покраской, отделочными работами или автоматической утилизацией.
...
- Утилизация не входит в базовый объём замены и должна быть согласована через чат до утверждения финальной цены заказа.
- ТЗ формируется через данные о новом кондиционере, установленном старом кондиционере, доступности наружного блока, месте установки, электрической точке и фотографии.

#### Вопросы клиенту — Заменить

1. Новый кондиционер уже находится на объекте?
- Да.
- Нет.

Если выбрано «Нет», система показывает сообщение:
- Для создания заказа на замену необходимо наличие приобретённого нового кондиционера на объекте.

[Понятно]

2. Новый кондиционер новый?
- Да, новый.
- Нет, бывший в использовании.
- Не знаю.

Если выбрано «Нет, бывший в использовании» или «Не знаю», система показывает сообщение:
- Helpy поддерживает замену только на новый кондиционер. Установка бывших в эксплуатации кондиционеров не входит в MVP.

[Понятно]

3. Старый кондиционер уже установлен?
- Да.
- Нет.
- Не знаю.

4. Новый кондиционер устанавливается на место старого?
- Да.
- Нет.
- Не знаю.

5. Нужно ли сохранить демонтированный кондиционер?
- Да.
- Нет.
- Не знаю.

6. Требуется ли утилизация?
- Да.
- Нет.
- Не знаю.

7. Доступен ли наружный блок?
- Да.
- Нет.
- Доступ с балкона.
- Сложный доступ.
...
8. Примерная мощность нового кондиционера:
- 9 000–12 000 BTU.
- 18 000 BTU.
- 24 000 BTU.
- Более 24 000 BTU.
...
1. Фото нового кондиционера в упаковке.
- 1 обязательная фотография.
...
3. Фото установленного старого внутреннего блока.
- 1 обязательная фотография.

4. Фото установленного старого наружного блока, если к нему есть безопасный доступ.
- До 1 дополнительной фотографии.

5. Фото места установки внутреннего блока.
- 1 обязательная фотография.

6. Фото электрической точки, розетки или зоны автомата, если они видны.
- 1 обязательная фотография.

7. Фото трассы, отверстия в стене или видимого участка коммуникаций, если они видны.
- До 1 дополнительной фотографии.
...
- Клиент не обязан понимать технические характеристики кондиционера.
- Клиент не обязан извлекать приобретённый товар из упаковки.
- Клиент не обязан самостоятельно демонтировать установленный кондиционер.
- Клиент не обязан самостоятельно проверять электропроводку, стену, трассу или крепления.
- Клиент не обязан приобретать дополнительные материалы и комплектующие до осмотра мастером.
- Клиент обязан обеспечить доступ к установленному кондиционеру, месту установки и зоне подключения.
