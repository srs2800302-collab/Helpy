...
MVP Architecture:
Appliance Installation & Connection is an equipment-first mini-TZ category.
Each equipment entity contains internal install_connect and replace scenarios.

Equipment entities:
- Стиральная машина → internal: Установить и подключить / Заменить.
- Посудомоечная машина → internal: Установить и подключить / Заменить.
- Измельчитель пищевых отходов → internal: Установить и подключить / Заменить.

Deferred MVP candidate:
- Другая бытовая техника — entity/materialization decision deferred.

MVP Scenario Rules:
- Each equipment entity offers two internal scenarios: Установить и подключить and Заменить.
- Установить и подключить is the base install / connect scenario.
- Заменить includes removal / dismantling of existing equipment followed by the install / connect scenario.
...
- If new equipment was physically placed by another party but still requires connection, the scenario remains Установить и подключить.
...
- Furniture Disassembly — STORED + DOCS ✅
...
Применение:
- Kitchen Assembly: нормализация ownership questions/photos/rules выполнена. Остаточный blocker: явные safety questions (wall fastening, stretch ceiling, reinforcements, lighting / electrical elements) не материализованы как client-facing questions — требуется DEFERRED business decision.
- Cabinet Furniture: нормализация ownership questions/photos/rules выполнена. Остаточный blocker: disassembly questions (no / disposal / preserve) и явные safety questions не материализованы как client-facing questions — требуется DEFERRED business decision.
- Built-in Furniture: нормализация ownership questions/photos/rules выполнена. Остаточный blocker: disassembly questions (no / disposal / preserve) не материализованы как client-facing questions — требуется DEFERRED business decision.
...
Назначение:
- Этот mini-ТЗ описывает кухонную сборку и установку кухонной мебели внутри Furniture Assembly.
- Сценарий применяется для сборки и установки кухонных модулей, столешницы, фурнитуры и комплектующих.
- Initial structured job scope формируется через фото мебели, проект, комплектовочный лист, фото места установки и фото инженерных выводов.
- Сценарий не является установкой и подключением бытовой техники, переносом сантехники или переносом электрических точек.

Scope:
- Сборка и установка кухонной мебели по проекту клиента.
- Установка модулей, столешницы, фурнитуры.
- Проверка комплектности, места установки и результата.
- Не входит: установка и подключение встроенной бытовой техники, перенос сантехники, перенос электрических точек, транспортировка, хранение, логистика мебели.
...
- Установка и подключение встроенной бытовой техники является отдельной услугой и отдельным заказом.
- Перенос сантехники не входит в кухонную сборку.
- Перенос электрических точек не входит в кухонную сборку.
- Транспортировка, хранение и логистика мебели не входят в кухонную сборку.
- Сортировка, упаковка, хранение и перемещение личных вещей клиента не входят в кухонную сборку.
- Дополнительные работы и материалы согласуются через чат до утверждения финальной цены заказа.
...
Назначение:
- Этот mini-ТЗ описывает сборку корпусной мебели внутри Furniture Assembly.
- Сценарий применяется для сборки шкафов, комодов, тумб, полок, кроватей, столов, стульев и мебельных комплектов.
- Initial structured job scope формируется через перечень мебели для сборки, фото мебели и фото помещения.
- Сценарий не является встроенной мебелью и не включает кухонную мебель.

Scope:
- Сборка и установка корпусной мебели.
- Проверка комплектности, устойчивости и результата.
- Не входит: встроенная мебель, кухонная мебель, транспортировка, хранение, логистика мебели.
...
- Встроенная мебель является отдельным сценарием и отдельным заказом.
- Кухонная мебель является отдельным сценарием и отдельным заказом.
- Транспортировка, хранение и логистика мебели не входят в сборку корпусной мебели.
- Сортировка, упаковка, хранение и перемещение личных вещей клиента не входят в сборку корпусной мебели.
- Дополнительные работы и материалы согласуются через чат до утверждения финальной цены заказа.
...
Назначение:
- Этот mini-ТЗ описывает установку встроенной мебели внутри Furniture Assembly.
- Сценарий применяется для монтажа встроенной мебели непосредственно в нише или месте установки.
- Initial structured job scope формируется через вопросы клиента, фото мебели, проект, схему наполнения и таблицу замеров ниши.
- Сценарий не является корпусной мебелью и не включает кухонную мебель.

Scope:
- Установка встроенной мебели: measurement → project → installation.
- Проверка комплектности, соответствия размеров ниши и результата.
- Не входит: корпусная мебель, кухонная мебель, транспортировка, хранение, логистика мебели.
...
- Корпусная мебель является отдельным сценарием и отдельным заказом.
- Кухонная мебель является отдельным сценарием и отдельным заказом.
- Транспортировка, хранение и логистика мебели не входят в установку встроенной мебели.
- Сортировка, упаковка, хранение и перемещение личных вещей клиента не входят в установку встроенной мебели.
- Дополнительные работы и материалы согласуются через чат до утверждения финальной цены заказа.
...
Применение:
- Regular Cleaning соответствует Cleaning Mini-TZ Standard ✅.
- Deep Cleaning соответствует Cleaning Mini-TZ Standard ✅.
- Post-Repair Cleaning соответствует Cleaning Mini-TZ Standard ✅.
...
### Subcategories
Active launch entities:
- Service.
- Install & Connect.
- Replacement.

Disabled / future / historical:
- Not Cooling.
- Leaking.
- Removal.
...
- Сценарий «Установить и подключить» применяется, когда приобретённое оборудование физически находится на объекте и требуется монтаж, подключение и базовая проверка результата.
- Сценарий «Заменить» применяется, когда приобретённое оборудование физически находится на объекте, а установленное оборудование требуется демонтировать перед монтажом приобретённого оборудования.
...
- Вопрос «Что требуется сделать?» не задаётся внутри action-entities, потому что клиент уже выбрал действие при выборе entity.
- Initial structured job scope формируется через выбранный сценарий, structured questions, client answers и required photos.
...
- Для stop-message используется формулировка «наличие приобретённого оборудования на объекте».
- Формулировка «наличие нового оборудования на объекте» не используется.
- В обязательных фотографиях используется формулировка «Фотография оборудования в упаковке».
- Формулировка «Фотография нового оборудования в упаковке» используется только в сценарии замены, если нужно явно отделить приобретаемое оборудование от установленного оборудования.
- Для фото упаковки используется формулировка «Фотография упаковки со всей информацией на ней или карточка приобретённого товара с технической информацией».
- Формулировка «Фотография упаковки нового оборудования...» не используется.
- В шаблонных правилах клиента, мастера, фотографий и проверок используется термин «оборудование», если конкретизация сущности не нужна.
- Для replacement-сценариев используется формулировка «Проверка оборудования до демонтажа установленного».
- Формулировка «Проверка нового оборудования до демонтажа установленного» не используется.

Применение:
- Замена замка межкомнатной двери соответствует Locks Mini-TZ Standard ✅.
- Установка замка межкомнатной двери соответствует Locks Mini-TZ Standard ✅.
- Замена мебельного замка соответствует Locks Mini-TZ Standard ✅.
- Установка врезного мебельного замка соответствует Locks Mini-TZ Standard ✅.
...
- Проверка включает совместимость, комплектность, целостность и возможность установки.
- При выявлении несовместимости мастер обязан сообщить об этом клиенту через чат приложения до продолжения работ.
- При обнаружении повреждений мастер обязан зафиксировать их на фотографиях и направить клиенту через чат приложения до демонтажа.
- Если клиент подтверждает продолжение работ, подтверждение клиента и фотографии становятся частью доказательной базы заказа.
