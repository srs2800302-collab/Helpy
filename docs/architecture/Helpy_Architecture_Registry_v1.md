...
- ТЗ формируется через подтверждение наличия нового оборудования, место установки, примерную мощность кондиционера, тип стены, место размещения наружного блока и фотографии.
...
2. Кондиционер находится на объекте?
- Да.
- Нет.

Если выбрано «Нет», система показывает сообщение:
- Для создания заказа необходимо наличие приобретённого кондиционера на объекте.

[Понятно]

3. Есть ли подготовленное место установки?
- Да.
- Нет.
- Не знаю.

4. Примерная мощность кондиционера:
- 9 000–12 000 BTU.
- 18 000 BTU.
- 24 000 BTU.
- Более 24 000 BTU.
...
6. Где будет размещён наружный блок?
- Балкон.
- На земле.
- На кронштейне.
...
- Вопрос о наличии кондиционера на объекте является стоп-условием.
- Если кондиционер был в использовании, клиент не уверен или кондиционер ещё не находится на объекте, заказ на установку не создаётся в рамках MVP.
- Наличие подготовленного места установки помогает оценить объём работ, но не гарантирует совместимость.
...
1. Фото кондиционера в упаковке.
- 1 обязательная фотография.
...
4. Фото места установки наружного блока, если к нему есть безопасный доступ.
- 1 обязательная фотография, если место безопасно доступно для клиента.

5. Фото электрической точки, розетки или зоны автомата, если они видны.
- 1 обязательная фотография.

6. Фото существующего отверстия, трассы или зоны прокладки коммуникаций, если они есть.
- До 1 дополнительной фотографии.
...
- Клиент не обязан приобретать дополнительные материалы и комплектующие до осмотра мастером.
- Клиент обязан обеспечить доступ к месту установки внутреннего блока и месту размещения наружного блока, если это безопасно.
