...
3. Демонтаж оборудования:
- Мастер выполняет отключение проточного водонагревателя от электропитания и водоснабжения в пределах стоимости услуги.
- Мастер выполняет демонтаж оборудования в пределах стоимости услуги.
- Демонтированное оборудование является собственностью клиента и остаётся на объекте.
