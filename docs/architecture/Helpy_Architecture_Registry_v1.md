...
- Замена состоит из демонтажа существующего оборудования и последующего выполнения сценария «Установить и подключить».
...
- Мастер устанавливает и подключает измельчитель пищевых отходов в пределах объёма услуги.
...
- Сценарий «Заменить» использует правила сценария «Установить и подключить» после завершения демонтажа существующего оборудования, если иное не указано явно.
...
- Сценарий «Заменить» состоит из демонтажа существующего оборудования и последующего выполнения сценария «Установить и подключить».
- После завершения демонтажа существующего оборудования сценарий «Заменить» использует правила сценария «Установить и подключить», если иное не указано явно.
...
1. Проверка совместимости до начала работ.
2. Проверка оборудования до установки.
3. Демонтаж существующего оборудования — только для сценария «Заменить».
...
Правило демонтажа:
- Демонтаж существующего оборудования применяется только в сценарии «Заменить».
- Демонтаж выполняется в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
- Упаковка кухонного смесителя/крана с двух сторон.
- Точки подключения воды под мойкой.
- Пространство под кухонной мойкой.

Дополнительные фотографии — Установить и подключить:
- Фото, позволяющее оценить расстояние между местом установки и точками подключения.

Обязательные фотографии — Заменить:
- Используются фотографии сценария «Установить и подключить».
- Общий вид установленного кухонного смесителя/крана.

Дополнительные фотографии — Заменить:
...
3. Установка и подключение:
- Мастер устанавливает и подключает кухонный смеситель/кран в пределах объёма услуги.
- Упаковка товара является собственностью клиента.
- Вынос или утилизация упаковки не входят в стоимость услуги.
...
1. Демонтаж существующего оборудования:
- Перед началом демонтажа мастер обязан отключить водоснабжение.
- Мастер выполняет демонтаж кухонного смесителя/крана в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
Назначение:
- Эта mini-scope сущность описывает установку нового проточного водонагревателя и замену существующего проточного водонагревателя внутри Kitchen Built-in Appliances.
- Сценарий наследует бизнес-логику Plumbing → Электрический душ (водонагреватель).
- Вопрос «Что требуется сделать?» находится на уровне Kitchen Built-in Appliances mini-scope экрана и не дублируется внутри этой mini-scope сущности.
- Установка включает монтаж нового проточного водонагревателя без демонтажа существующего оборудования.
- Замена состоит из демонтажа существующего оборудования и последующего выполнения сценария «Установить новый».

Если выбрано «Установить новый»:
...
Обязательные фотографии — Установить новый:
- Упаковка нового проточного водонагревателя со всей информацией на ней.
- От 1 до 3 фотографий, позволяющих оценить место установки проточного водонагревателя, расположение точки подключения воды и расположение ближайшего электрического подключения.

Обязательные фотографии — Заменить:
- Упаковка нового проточного водонагревателя со всей информацией на ней.
- Общий вид существующего проточного водонагревателя, позволяющий оценить условия демонтажа и замены.
...
Правила для клиента:
- Клиент не обязан понимать технические характеристики проточного водонагревателя.
- Клиент не обязан вскрывать упаковку оборудования для создания заказа.
- Клиент не обязан разбирать розетки, автоматы или проводку.
- Клиент не обязан выполнять действия, связанные с электричеством.
- Клиент не обязан производить измерения.
- Клиент не обязан самостоятельно демонтировать существующий проточный водонагреватель.
- Клиент не обязан приобретать дополнительные материалы и комплектующие до осмотра мастером.
- Клиент обязан обеспечить доступ к месту установки.
- Если оборудование отсутствует на объекте, форма заказа останавливается.

Правила выполнения работ мастером — Установить новый:
- Наследуются из Plumbing → Электрический душ (водонагреватель) с переименованием сущности в «Проточный водонагреватель».

Правила выполнения работ мастером — Заменить:
- Сценарий «Заменить» использует правила сценария «Установить новый» после завершения демонтажа существующего оборудования, если иное не указано явно.
- Демонтированный проточный водонагреватель является собственностью клиента и остаётся на объекте.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет отключение варочной панели от электропитания в пределах объёма услуги замены.
- Мастер выполняет демонтаж варочной панели в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
3. Установка и подключение:
- Мастер устанавливает и подключает духовой шкаф в пределах объёма услуги.
- Упаковка товара является собственностью клиента.
- Вынос или утилизация упаковки не входят в стоимость услуги.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет отключение духового шкафа от электропитания в пределах объёма услуги замены.
- Мастер убирает крепёжные элементы и извлекает духовой шкаф из ниши в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
3. Установка и подключение:
- Мастер устанавливает и подключает микроволновую печь в пределах объёма услуги.
- Упаковка товара является собственностью клиента.
- Вынос или утилизация упаковки не входят в стоимость услуги.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет отключение микроволновой печи от электропитания в пределах объёма услуги замены.
- Мастер убирает крепёжные элементы и извлекает микроволновую печь из ниши в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
3. Установка и подключение:
- Мастер устанавливает и подключает кухонную вытяжку в пределах объёма услуги.
- Если выбран режим подключения к вентиляции, мастер выполняет подключение воздуховода длиной не более 2,5 метров при наличии вентиляционного отверстия, в пределах объёма услуги.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет отключение кухонной вытяжки от электропитания в пределах объёма услуги замены.
- Мастер убирает крепёжные элементы и демонтирует кухонную вытяжку в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
- Тип крепления фасадов не спрашивается.
- Наличие доводчиков не спрашивается.
- Тип системы крепления фасадов не спрашивается.
- Наличие системы No Frost не спрашивается.
- Наличие льдогенератора не спрашивается.
- Наличие диспенсера воды не спрашивается.
- Размер ниши является характеристикой места установки, а не технической характеристикой оборудования.
- При замене существующий встроенный холодильник оценивается по фотографиям.
- При замене существующие фасады оцениваются по фотографиям.
- Если планируется замена фасадов, информация о новых фасадах оценивается по фотографиям.
- Эти детали оцениваются по фотографиям и при необходимости уточняются через чат.
- Дополнительные материалы, комплектующие и расходники регулируются Global Materials Separation Rule.
...
3. Фотографии с размерами устанавливаемых фасадов.
- До 2 фотографий:
  - 1 обязательная;
  - до 1 дополнительной.
...
Если выбрано «Да» в вопросе «Планируется замена фасадов?»:

4. Фотографии с размерами устанавливаемых фасадов.
- До 2 фотографий:
  - 1 обязательная;
  - до 1 дополнительной.
...
3. Установка и подключение:
- Мастер устанавливает и подключает встроенный холодильник в пределах объёма услуги.
- Если на объекте присутствует нужный мебельный фасад, мастер выполняет его установку на технику и выполняет регулировку в процессе монтажа.
- Упаковка товара является собственностью клиента.
- Вынос или утилизация упаковки не входят в стоимость услуги.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет отключение встроенного холодильника от электропитания в пределах объёма услуги замены.
- Мастер выполняет демонтаж встроенной техники и мебельных фасадов в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
- Наличие вилки не спрашивается.
- Наличие заземления не спрашивается.
- Тип системы крепления фасада не спрашивается.
...
3. Фотография с размерами устанавливаемого фасада.
- 1 обязательная фотография.
...
Правило фотографии зоны подключения:
- Фотографии должны позволять оценить подключение воды, организацию слива и наличие точки электропитания.
...
Если выбрано «Да» в вопросе «Планируется замена фасада?»:

4. Фотография с размерами устанавливаемого фасада.
- 1 обязательная фотография.

Лимит фотографий — Заменить без замены фасада:
- Обязательные: 4 фотографии.
- Дополнительные: до 2 фотографий.
- Всего: до 6 из 10 фотографий.

Лимит фотографий — Заменить с заменой фасада:
- Обязательные: 5 фотографий.
- Дополнительные: до 2 фотографий.
- Всего: до 7 из 10 фотографий.
...
3. Установка и подключение:
- Мастер устанавливает и подключает встроенную посудомоечную машину в пределах объёма услуги.
- Если на объекте присутствует нужный мебельный фасад, мастер выполняет его установку на технику и выполняет регулировку в процессе монтажа.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет отключение встроенной посудомоечной машины от электропитания, водоснабжения и системы водоотведения в пределах объёма услуги замены.
- Мастер выполняет демонтаж встроенной техники и мебельного фасада в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
3. Установка и подключение:
- Мастер устанавливает и подключает встроенную стиральную машину в пределах объёма услуги.
- Если на объекте присутствует нужный мебельный фасад, мастер выполняет его установку на технику и выполняет регулировку в процессе монтажа.
- Подключение оборудования выполняется в соответствии с требованиями производителя.
- Упаковка товара является собственностью клиента.
- Вынос или утилизация упаковки не входят в стоимость услуги.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет отключение встроенной стиральной машины от электропитания, водоснабжения и системы водоотведения в пределах объёма услуги замены.
- Мастер выполняет демонтаж встроенной техники и мебельного фасада в пределах объёма услуги замены.
- Демонтированное оборудование остаётся собственностью клиента и оставляется на объекте.
...
Architecture: Plumbing mini-ТЗ template ✅

Назначение:
- Этот mini-ТЗ описывает установку нового крана/смесителя и замену существующего крана/смесителя внутри Plumbing.
- Вопрос «Что требуется сделать?» остаётся внутри mini-ТЗ, потому что это не mini-scope / add-more ветка.
- Установка включает монтаж, подключение и базовую проверку результата.
- Замена включает демонтаж существующего крана/смесителя, монтаж нового крана/смесителя, подключение и базовую проверку результата.

Что требуется сделать?
- Установить новый кран/смеситель.
- Заменить существующий кран/смеситель.
...
Если выбрано «Установить новый кран/смеситель»:

1. Новый кран/смеситель находится на объекте?
- Да → продолжить форму.
- Нет → остановить форму. Клиент создаёт заказ только после того, как оборудование физически находится на объекте.
...
Если выбрано «Заменить существующий кран/смеситель»:
...
Обязательные фотографии — Установить новый — Раковина:
...
Дополнительные фотографии — Установить новый — Раковина:
- Пространство под раковиной, если есть возможность сделать такую фотографию.

Обязательные фотографии — Установить новый — Кухня:
- Общий вид кухонной мойки и места установки.
- Упаковка нового крана/смесителя с двух сторон.
- Точки подключения воды под мойкой.
- Пространство под кухонной мойкой.

Дополнительные фотографии — Установить новый — Кухня:
- Фото, позволяющее оценить расстояние между местом установки и точками подключения.

Обязательные фотографии — Установить новый — Душ:
- Общий вид душевой зоны.
- Упаковка нового крана/смесителя с двух сторон.
- Место установки.
- Точки подключения воды.

Не требуется — Установить новый — Душ:
- Фото проточного водонагревателя.

Обязательные фотографии — Установить новый — Балкон:
- Общий вид места установки.
- Упаковка нового крана/смесителя с двух сторон.
- Точки подключения воды.

Не требуется — Установить новый — Балкон:
- Фото окружающего пространства балкона.

Обязательные фотографии — Заменить существующий:
- Используются фотографии сценария «Установить новый» для выбранного места установки.
- Дополнительно клиент прикрепляет фотографии существующего крана/смесителя по правилам ниже.

Дополнительные фотографии — Заменить существующий — Раковина:
- Общий вид существующего крана.
- Фото крепления снизу, если доступно.

Дополнительные фотографии — Заменить существующий — Кухня:
- Общий вид существующего крана/смесителя.
- Фото крепления снизу, если доступно.

Дополнительные фотографии — Заменить существующий — Душ:
- Общий вид существующего душевого смесителя.

Дополнительные фотографии — Заменить существующий — Балкон:
- Общий вид существующего крана.
...
- Мастер обязан проверить соединения на отсутствие видимых протечек.
- Мастер обязан предоставить клиенту готовый результат.
- Услуга не считается качественно выполненной до подтверждения базовой работоспособности результата работ в рамках согласованного объёма заказа.

Правила выполнения работ мастером — Заменить существующий:
- Сценарий «Заменить существующий» использует правила сценария «Установить новый» после завершения демонтажа существующего оборудования, если иное не указано явно.

1. Демонтаж существующего оборудования:
- Перед началом демонтажа мастер обязан отключить воду.
- Мастер демонтирует существующий кран/смеситель в пределах объёма услуги замены.
...
- Вынос или утилизация демонтированного оборудования не является услугой Helpy, не входит в стоимость заказа и не является предметом спора платформы.
...
Назначение:
- Этот mini-ТЗ описывает установку нового электрического душа и замену существующего электрического душа внутри Plumbing.
- Вопрос «Что требуется сделать?» остаётся внутри mini-ТЗ, потому что это не mini-scope / add-more ветка.
...
- Установка включает монтаж нового электрического душа без демонтажа существующего оборудования.
- Замена включает демонтаж существующего электрического душа, установку нового электрического душа, подключение и базовую проверку результата.
...
Если выбрано «Заменить существующий»:
...
Правила фотографий — Установить новый:
...
Правила фотографий — Заменить существующий:
- Клиент не демонтирует существующее оборудование.
- Клиент не вскрывает корпус устройства.
- Клиент не разбирает розетки, автоматы или проводку.
- Клиент не выполняет действий, связанных с электричеством.
...
- Клиент не обязан выполнять действия, связанные с электричеством.
- Клиент не обязан производить измерения.
- Клиент не обязан самостоятельно демонтировать существующий электрический душ.
- Клиент не обязан приобретать дополнительные материалы и комплектующие до осмотра мастером.
- Клиент обязан обеспечить доступ к месту установки.
- Если оборудование отсутствует на объекте, форма заказа останавливается.
...
1. Демонтаж существующего оборудования:
- Мастер выполняет демонтаж существующего электрического душа в пределах объёма услуги замены.
