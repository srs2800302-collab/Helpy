...
- Не набирается вода в бачок 🟨 RE-AUDIT
- Вода постоянно течет в чашу 🟨 RE-AUDIT
...
GAP:
- Завершить аудит ветки «Не набирается вода в бачок».
- Завершить аудит ветки «Вода постоянно течет в чашу».
