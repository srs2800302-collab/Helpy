...
- При подтверждение клиентом, продолжения работ, фотографии становятся доказательной базой заказа.
- Мастер обязан проверить комплектность оборудования и наличие штатных элементов подключения.
- Мастер вправе отказаться от продолжения работ, если безопасное выполнение работ невозможно.
...
- Дополнительные комплектующие и расходные материалы являются отдельной договорённостью между клиентом и мастером.
- Мастер устанавливает и подключает оборудование в пределах стоимости услуги.
- Мастер установливает мебельный фасад на оборудование, выполняет регулировку по зазорам и плоскости в процессе установки.
- Подключение оборудования выполняется в соответствии с требованиями производителя.
- Утилизация упаковки не входит в стоимость услуги, поскольку является собственностью клиента.
...
1. Демонтаж оборудования:
- Мастер отключяет оборудование от всех коммуникаций и выполняет демонтаж техники и мебельного фасада пределах стоимости услуги.
- Демонтированное оборудование является собственностью клиента и остаётся на объекте.
...
1. Демонтаж оборудования:
- Мастер выполняет отключение от электропитания, водоснабжения, системы водоотведения и демонтаж встроенной техники и мебельного фасада в пределах стоимости услуги.
- Демонтированное оборудование является собственностью клиента и остаётся на объекте.
