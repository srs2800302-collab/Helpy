...
Назначение:
Единый утверждённый словарь клиентских и мастерских формулировок Helpy. Используется как источник истины для всех клиентских правил и правил выполнения работ мастером.
