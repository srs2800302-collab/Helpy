...
Definition:
- Установка = монтаж новой розетки без демонтажа существующего изделия.
...
- До 2 дополнительных фотографий.
- Фото оборудования не заменяет фото места установки.
- Одно фото может покрывать несколько одинаковых изделий, если мастер видит тип, модель и количество.

Photo Rule — Установить и подключить:
...
Photo Limits — Установить и подключить:
- Обязательные: 1 фотография.
- Дополнительные: до 2 фотографий.
- Всего: до 3 фотографий.

Chat Completion Rule — Установить и подключить:
...
Definition:
- Замена = демонтаж существующей розетки + установка новой розетки.
...
2. Фото новых изделий, если они уже есть на объекте.
- До 2 дополнительных фотографий.
- Фото оборудования не заменяет фото существующей точки замены.
- Одно фото может покрывать несколько одинаковых изделий, если мастер видит тип, модель и количество.
...
Photo Limits — Заменить:
- Обязательные: 1 фотография.
- Дополнительные: до 2 фотографий.
- Всего: до 3 фотографий.

Demolished Equipment Rule — Заменить:
...
Definition:
- Перенос = демонтаж существующей розетки + изменение расположения + установка розетки в новом месте.
- По умолчанию при переносе используется существующая розетка.
- Если клиент предоставляет новую розетку, мастер устанавливает новую розетку вместо существующей.
...
Photo Limits — Перенести:
- Обязательные: 2 фотографии.
- Дополнительные: до 2 фотографий.
- Всего: до 4 фотографий.

Demolished Equipment Rule — Перенести:
- Демонтированное изделие является собственностью клиента.
- Демонтированное изделие остаётся на объекте по умолчанию.
- Утилизация или вынос возможны только по отдельной договорённости через чат.

Decoration Rule — Перенести:
...
Chat Completion Rule — Перенести:
...
- Сценарий «Заменить» включает демонтаж существующей розетки и установку новой розетки.
- Сценарий «Перенести» включает перенос розетки только в пределах согласованного объёма.
...
Definition:
- Установка = монтаж нового выключателя без демонтажа существующего изделия.
- Одна точка установки = одно mini-ТЗ.
...
Definition:
- Замена = демонтаж существующего выключателя + установка нового выключателя.
- Одна точка замены = одно mini-ТЗ.
...
Definition:
- Перенос = демонтаж существующего выключателя + изменение расположения + установка выключателя в новом месте.
- По умолчанию при переносе используется существующий выключатель.
- Если клиент предоставляет новый выключатель, мастер устанавливает новый выключатель вместо существующего.
- Одна точка переноса = одно mini-ТЗ.
...
- Сценарий «Заменить» включает демонтаж существующего выключателя и установку нового выключателя.
- Сценарий «Перенести» включает перенос выключателя только в пределах согласованного объёма.
- Если требуются дополнительные материалы, комплектующие или расходники, применяется Global Materials Separation Rule.
