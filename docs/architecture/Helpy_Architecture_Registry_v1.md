...
- Кухонный кран может быть отдельной mini-scope сущностью внутри Kitchen Built-in Appliances и наследует бизнес-логику Plumbing → Кран.
...
- Сценарий наследует бизнес-логику Plumbing → Кран.
...
Применение:
- Кран должен быть приведён к Plumbing Mini-TZ Standard.
- Унитаз должен быть приведён к Plumbing Mini-TZ Standard.
- Электрический душ должен быть приведён к Plumbing Mini-TZ Standard с учётом Global Electrical Readiness Rule.
