...
Применение:
- Встроенный холодильник должен быть приведён к этому стандарту при ближайшем аудите.
- Встроенная посудомоечная машина проектируется по этому стандарту.
- Встроенная стиральная машина проектируется по этому стандарту с учётом правил обычной стиральной машины.
- Встроенная микроволновая печь проектируется по этому стандарту и наследует архитектуру встроенного духового шкафа.
