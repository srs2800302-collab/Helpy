...
- Уберите содержимое оборудования до приезда мастера.
- Подготовьте безопасные условия для выполнения работ.
...
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте доступ к пространству под мойкой.
...
- Вы не обязаны выполнять работы с электрикой.
- Вы не обязаны разбирать систему водоотведения или элементы мойки.
- Вы не обязаны самостоятельно снимать установленное оборудование.
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте доступ к пространству под мойкой.
- Подготовьте доступ для работы с электрикой.
- Подготовьте безопасные условия для выполнения работ.
...
- Вы не обязаны распаковывать товар.
- Вы не обязаны изменять существующее отверстие в столешнице.
- Вы не обязаны изготавливать новое отверстие в столешнице.
- Подготовьте доступ к месту выполнения работ.
...
- Вы не обязаны разбираться в технических характеристиках.
- Вы не обязаны распаковывать товар.
- Вы не обязаны самостоятельно отключать водоснабжение.
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте доступ к месту выполнения работ.
- Подготовьте рабочую зону к приезду мастера.
...
- Вы не обязаны самостоятельно выполнять работы с электрикой.
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте место для установки.
- Подготовьте безопасные условия для выполнения работ.
...
- Вы не обязаны распаковывать товар.
- Вы не обязаны самостоятельно выполнять работы с электрикой.
- Вы не обязаны самостоятельно изменять существующее отверстие в столешнице.
- Вы не обязаны самостоятельно изготавливать новое отверстие в столешнице.
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте доступ к месту выполнения работ.
- Подготовьте доступ для работы с электрикой.
- Подготовьте безопасные условия для выполнения работ.
...
- Вы не обязаны распаковывать товар.
- Вы не обязаны самостоятельно выполнять работы с электрикой.
- Вы не обязаны самостоятельно отключать установленное оборудование.
- Вы не обязаны снимать установленное оборудование.
- Вы не обязаны самостоятельно изменять существующее отверстие в столешнице.
- Вы не обязаны самостоятельно изготавливать новое отверстие в столешнице.
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте доступ к установленному оборудованию.
...
## Client Rules Language & Translation Standard

Status: APPROVED / STORED ✅

Назначение:
- Этот стандарт определяет единый стиль написания правил для клиента.
- Стандарт применяется ко всем существующим и будущим клиентским правилам Helpy.
- Каждая новая клиентская формулировка должна сохранять смысл при переводе между RU, EN и TH.
- Приоритет отдаётся коротким, понятным и легко переводимым фразам.

### Паттерн: Вы не обязаны...

Используется для снятия технической ответственности с клиента.
...
- Вы не обязаны самостоятельно снимать установленное оборудование.
- Вы не обязаны самостоятельно отключать водоснабжение.
- Вы не обязаны самостоятельно отключать воду.
- Вы не обязаны самостоятельно выполнять работы с электрикой.
- Вы не обязаны самостоятельно подготавливать систему водоотвода.
...
Используется для действий клиента до приезда мастера.
...
- Для клиентских инструкций глагол «Подготовьте» является предпочтительным по отношению к глаголу «Обеспечьте».
- Причина: лучше сохраняет смысл при переводе RU ↔ EN ↔ TH и воспринимается как понятное действие клиента.

### Паттерн: Предоставьте...

Используется для передачи обязательной информации или материалов внутри сценария заказа.
...
Используется для освобождения оборудования или рабочей зоны до приезда мастера.

Утверждённые формулировки:
- Уберите содержимое оборудования до приезда мастера.

### Требования к новым клиентским формулировкам

- Формулировка должна быть короткой и понятной.
- Формулировка должна использовать единый паттерн языка клиента.
- Формулировка должна сохранять смысл при переводе RU ↔ EN ↔ TH.
- Формулировка не должна содержать излишне юридических или технических конструкций.
- Формулировка должна быть понятна без дополнительного объяснения внутри сценария заказа.

### Дополнительно утверждённые формулировки

#### Паттерн: Уберите...

- Уберите личные вещи до начала работ.
- Уберите документы, деньги и ценные вещи до начала работ.
- Уберите ценные вещи из рабочей зоны.
- Уберите домашних животных из рабочей зоны.
- Уберите препятствия из рабочей зоны.

#### Паттерн: Electrical safety

Используется для сценариев, где клиент не должен выполнять небезопасные действия с электрикой, щитом, проводкой или внутренними соединениями.
...
#### Паттерн: Plumbing / water drainage safety

Используется для сценариев, где клиент не должен разбирать водоотведение, элементы мойки, трап, унитаз или другие элементы сантехники.
...
#### Паттерн: Cleaning classification

Используется для сценариев уборки, где клиент не обязан определять тип загрязнений до приезда мастера.

Утверждённые формулировки:

- Вы не обязаны классифицировать загрязнения.
- Подготовьте мебель для внутренней уборки, если она входит в согласованный объём услуги.

#### Паттерн: Client safety / diagnostics

Используется для сценариев, где клиент не обязан выполнять диагностику, определять техническую причину проблемы или совершать опасные действия для передачи информации.

Утверждённые формулировки:

- Вы не обязаны самостоятельно определять техническую причину проблемы.
- Вы не обязаны выполнять диагностику неисправностей.
- Вы не обязаны выполнять опасные действия для предоставления информации о проблеме.
- Уберите личные вещи, которые могут препятствовать выполнению работ.

#### Паттерн: Подготовьте место...

Используется для подготовки пространства до начала работ.

Утверждённые формулировки:

- Подготовьте место для установки.
- Подготовьте место для замены.
- Подготовьте место для выполнения работ.

Утверждённое наблюдение:

- Формулировки через «Подготовьте место для...» успешно сохраняют смысл при переводе RU ↔ EN ↔ TH.
- Для сценариев установки и замены допускается использование краткой формы без указания оборудования, если контекст сценария уже определён выбранной услугой.

### Conserved / Disabled Branch Language Rule

- Disabled, historical, future and stored documentation branches are not priority targets for active client-rule normalization.
- If client-language normalization has already been applied to those branches and does not change business meaning, the change may remain.
- Conserved Plumbing blocks remain excluded unless explicitly reopened for audit.

### Multilanguage Validation Rule

Перед утверждением новой клиентской формулировки рекомендуется выполнять проверку:
- RU → EN.
- RU → TH.
- EN → RU.
- TH → RU.
...
Формулировка считается пригодной к использованию после подтверждения сохранения исходного смысла во всех направлениях перевода.
...
#### Правила для клиента — Обслуживание

- Вы не обязаны знать тип кондиционера.
- Вы не обязаны знать мощность оборудования.
- Вы не обязаны самостоятельно выполнять диагностику кондиционера.
- Вы не обязаны разбирать кондиционер или снимать его элементы для создания заказа.
- Подготовьте доступ к месту выполнения работ.
- Подготовьте безопасный доступ к наружному блоку в рамках согласованного объёма работ.
- Уберите личные вещи, которые могут препятствовать выполнению работ.
...
- Вы не обязаны разбираться в технических характеристиках.
- Вы не обязаны распаковывать товар.
- Вы не обязаны самостоятельно проверять электропроводку, стену, трассу или крепления.
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте доступ к месту выполнения работ.
- Вы не обязаны выполнять опасные действия для фотографирования места установки наружного блока.
...
### 22.5 Replacement
Status: APPROVED / DRAFT / NEEDS REVIEW / STORED ✅
Standard Compliance: Air Conditioning Mini-TZ Standard ✅
...
Status:
- APPROVED / DISABLED ON LAUNCH / STORED + DOCS ✅
...
Stored Documentation — Правила для клиента — Неисправность бачка унитаза:
