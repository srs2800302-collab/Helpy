...
- В правилах для клиента не используются формулировки со словом «клиент».
...
Используется для освобождения оборудования, рабочей зоны или защиты имущества до приезда мастера.
...
- Новая формулировка добавляется только если существующий словарь не покрывает смысл.
...
- Новая клиентская формулировка считается готовой только после проверки RU ↔ EN ↔ TH.
- Если обратный перевод меняет смысл, формулировка не добавляется в словарь.
- Предпочтение отдаётся более короткой формулировке, если смысл сохраняется во всех направлениях перевода.
