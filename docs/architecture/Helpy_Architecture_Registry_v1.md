...
Назначение:
- Этот mini-ТЗ описывает установку нового крана/смесителя и замену установленного крана/смесителя внутри Plumbing.
- Вопрос «Что требуется сделать?» остаётся внутри mini-ТЗ, потому что Plumbing не является mini-scope / add-more веткой.
- Установка включает монтаж, подключение воды и базовую проверку результата.
- Замена состоит из демонтажа установленного крана/смесителя и последующего выполнения сценария «Установить новый кран/смеситель».
...
2. Новый кран/смеситель находится на объекте?
- Да.
- Нет.

Если клиент выбирает «Нет», система показывает сообщение:
- Для установки крана/смесителя требуется наличие нового крана/смесителя на объекте.

[Понятно]

3. Где будет установлен новый кран/смеситель?
- Раковина.
- Кухня.
- Душ.
- Балкон.
...
Если клиент выбирает «Нет», система показывает сообщение:
- Для замены крана/смесителя требуется наличие нового крана/смесителя на объекте.
...
Обязательные фотографии — Установить новый кран/смеситель — Раковина:

1. Общий вид раковины и места установки.
- 1 обязательная фотография.

2. Фото нового крана/смесителя в упаковке.
- 1 обязательная фотография.

3. Фото упаковки нового крана/смесителя со всей информацией на ней или карточка приобретённого товара с технической информацией.
- До 4 фотографий:
  - 1 обязательная;
  - до 3 дополнительных.
...
Дополнительные фотографии — Установить новый кран/смеситель — Раковина:

1. Фото пространства под раковиной.
- До 1 дополнительной фотографии.

Лимит фотографий — Установить новый кран/смеситель — Раковина:
- Обязательные: 5 фотографий.
- Дополнительные: до 4 фотографий.
- Всего: до 9 из 10 фотографий.

Обязательные фотографии — Установить новый кран/смеситель — Кухня:
...
Дополнительные фотографии — Установить новый кран/смеситель — Кухня:

1. Фото, позволяющее оценить расстояние между местом установки и точками подключения.
- До 1 дополнительной фотографии.

Лимит фотографий — Установить новый кран/смеситель — Кухня:
- Обязательные: 5 фотографий.
- Дополнительные: до 4 фотографий.
- Всего: до 9 из 10 фотографий.

Обязательные фотографии — Установить новый кран/смеситель — Душ:
...
Не требуется — Установить новый кран/смеситель — Душ:
- Фото проточного водонагревателя.

Лимит фотографий — Установить новый кран/смеситель — Душ:
- Обязательные: 5 фотографий.
- Дополнительные: до 3 фотографий.
- Всего: до 8 из 10 фотографий.

Обязательные фотографии — Установить новый кран/смеситель — Балкон:
...
Не требуется — Установить новый кран/смеситель — Балкон:
- Фото окружающего пространства балкона.

Лимит фотографий — Установить новый кран/смеситель — Балкон:
- Обязательные: 4 фотографии.
- Дополнительные: до 3 фотографий.
- Всего: до 7 из 10 фотографий.

Обязательные фотографии — Заменить установленный кран/смеситель:
- Используются фотографии сценария «Установить новый кран/смеситель» для выбранного места установки.
- Дополнительно клиент прикрепляет фотографии установленного крана/смесителя по правилам ниже.

Дополнительные фотографии — Заменить установленный кран/смеситель — Раковина:
...
Дополнительные фотографии — Заменить установленный кран/смеситель — Кухня:
...
Дополнительные фотографии — Заменить установленный кран/смеситель — Душ:

1. Общий вид установленного душевого смесителя.
- 1 обязательная фотография.

Дополнительные фотографии — Заменить установленный кран/смеситель — Балкон:

1. Общий вид установленного крана.
- 1 обязательная фотография.

Правило лимита фотографий — Заменить установленный кран/смеситель:
- Итоговый лимит рассчитывается как лимит выбранного сценария «Установить новый кран/смеситель» плюс обязательные фотографии установленного крана/смесителя.
- Общий лимит заказа не должен превышать 10 фотографий.

Правила для клиента — Установить новый кран/смеситель:
- Клиент не обязан определять тип крана/смесителя.
- Клиент не обязан понимать технические характеристики оборудования.
- Клиент не обязан извлекать новый кран/смеситель из упаковки.
- Клиент не обязан самостоятельно отключать водоснабжение.
- Клиент не обязан приобретать дополнительные материалы и комплектующие до осмотра мастером.
- Клиент обязан обеспечить доступ к месту выполнения работ.
...
- Клиент обязан подготовить рабочую зону к моменту приезда мастера.
- Если новое оборудование отсутствует на объекте, форма заказа останавливается.

Правила выполнения работ мастером — Установить новый кран/смеситель:
...
- Сценарий «Заменить установленный кран/смеситель» использует правила сценария «Установить новый кран/смеситель» после завершения демонтажа установленного крана/смесителя, если иное не указано явно.

1. Проверка нового крана/смесителя до демонтажа установленного:
- Если работа предполагает замену крана/смесителя, мастер обязан проверить новый кран/смеситель до демонтажа установленного.
- Проверка включает совместимость, комплектность, целостность и возможность установки.
...
Назначение:
- Этот mini-ТЗ описывает установку нового унитаза, замену установленного унитаза и bounded problem-flow сценарии неисправности бачка унитаза внутри Plumbing.
- Вопрос «Что требуется сделать?» остаётся внутри mini-ТЗ, потому что Plumbing не является mini-scope / add-more веткой.
- Установка включает монтаж, подключение воды, подключение канализационного выпуска и базовую проверку результата.
- Замена состоит из демонтажа установленного унитаза и последующего выполнения сценария «Установить новый унитаз».
...
Если выбрано «Установить новый унитаз»:

2. Новый унитаз находится на объекте?
- Да.
- Нет.

Если клиент выбирает «Нет», система показывает сообщение:
- Для установки унитаза требуется наличие нового унитаза на объекте.
...
Если клиент выбирает «Нет», система показывает сообщение:
- Для замены унитаза требуется наличие нового унитаза на объекте.
...
Обязательные фотографии — Установить новый унитаз:

1. Фото места установки.
- 1 обязательная фотография.

2. Фото упаковки нового унитаза со всей информацией на ней или карточка приобретённого товара с технической информацией.
- До 4 фотографий:
  - 2 обязательные;
  - до 2 дополнительных.

3. Фото точки подключения воды.
- 1 обязательная фотография.

4. Фото канализационного выпуска.
- 1 обязательная фотография.

Лимит фотографий — Установить новый унитаз:
- Обязательные: 5 фотографий.
- Дополнительные: до 2 фотографий.
- Всего: до 7 из 10 фотографий.
...
1. Фото нового унитаза в упаковке.
- 1 обязательная фотография.
...
Правила для клиента — Установить новый унитаз:
- Клиент не обязан понимать технические характеристики унитаза.
- Клиент не обязан извлекать новый унитаз из упаковки.
...
Правила выполнения работ мастером — Установить новый унитаз:
...
2. Проверка оборудования до установки:
- До установки мастер обязан выполнить визуальный осмотр нового унитаза.
- Проверка включает наличие видимых механических повреждений и комплектность в пределах штатных элементов установки.
- При обнаружении повреждений или отсутствия необходимых штатных элементов мастер обязан зафиксировать это на фотографиях и направить клиенту через чат платформы до продолжения работ.
- Если клиент подтверждает продолжение работ, подтверждение клиента и фотографии становятся частью доказательной базы заказа.
...
- Сценарий «Заменить установленный унитаз» использует правила сценария «Установить новый унитаз» после завершения демонтажа установленного унитаза, если иное не указано явно.

1. Проверка нового унитаза до демонтажа установленного:
- Если работа предполагает замену унитаза, мастер обязан проверить новый унитаз до демонтажа установленного.
- Проверка включает совместимость, комплектность, целостность и возможность установки.
