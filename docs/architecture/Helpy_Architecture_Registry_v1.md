...
- Подготовьте доступ к электрической точке подключения.
...
- Вы не обязаны заранее покупать дополнительные материалы или комплектующие.
- Подготовьте доступ к месту установки.
- Подготовьте безопасные условия для выполнения работ.
...
- Клиент не обязан самостоятельно определять способ разборки мебели и порядок демонтажа, тип крепежа или технологию выполнения работ.
...
- Клиент не обязан быть техническим специалистом по кондиционерам.
- Клиент не обязан самостоятельно диагностировать неисправности.
- Клиент не обязан разбирать кондиционер, снимать элементы оборудования или выполнять действия, которые могут быть небезопасны.
- Клиент обязан обеспечить доступ к месту выполнения работ к моменту приезда мастера.
- Клиент обязан убрать личные вещи, которые могут препятствовать выполнению работ.
...
- Клиент не обязан знать тип кондиционера.
- Клиент не обязан знать мощность оборудования.
- Клиент не обязан самостоятельно выполнять диагностику кондиционера.
- Клиент не обязан разбирать кондиционер или снимать его элементы для создания заказа.
- Клиент обязан обеспечить доступ к месту выполнения работ к моменту приезда мастера.
- Клиент обязан обеспечить безопасный доступ к наружному блоку в рамках согласованного объёма работ.
- Клиент обязан убрать личные вещи, которые могут препятствовать выполнению работ.
...
- Клиент не обязан самостоятельно определять скрытое состояние стены, электропроводки или трассы.
...
- Клиент не обязан понимать технические характеристики кондиционера.
- Клиент не обязан извлекать приобретённый товар из упаковки.
- Клиент не обязан самостоятельно проверять электропроводку, стену, трассу или крепления.
- Клиент не обязан приобретать дополнительные материалы и комплектующие до осмотра мастером.
- Клиент обязан обеспечить безопасный доступ к месту установки.
- Клиент не обязан выполнять опасные действия для фотографирования места установки наружного блока.
...
- Клиент не обязан выполнять опасные действия для проверки доступа к наружному блоку.
...
- Клиент не обязан выполнять опасные действия для фотографирования наружного блока.
