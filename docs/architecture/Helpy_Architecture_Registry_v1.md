...
- Установка включает монтаж, подключение и базовую проверку результата.
- Замена включает демонтаж установленного крана/смесителя, монтаж нового крана/смесителя, подключение и базовую проверку результата.
...
Обязательные фотографии — Заменить установленный:
...
Дополнительные фотографии — Заменить установленный — Раковина:
- Общий вид установленного крана.
- Фото крепления снизу, если доступно.

Дополнительные фотографии — Заменить установленный — Кухня:
- Общий вид установленного крана/смесителя.
- Фото крепления снизу, если доступно.

Дополнительные фотографии — Заменить установленный — Душ:
- Общий вид установленного душевого смесителя.

Дополнительные фотографии — Заменить установленный — Балкон:
- Общий вид установленного крана.
...
Правила выполнения работ мастером — Заменить установленный:
- Сценарий «Заменить установленный» использует правила сценария «Установить новый» после завершения демонтажа установленного оборудования, если иное не указано явно.
