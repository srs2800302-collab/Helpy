...
Definition:
- Перенос = демонтаж + установка и подключение в новом месте.
...
- Вы не обязаны выполнять опасные действия для предоставления информации.
- Вы не обязаны разбирать оборудование.
- Фотография оборудования не заменяет фотографию места установки.
- Одна фотография может покрывать несколько одинаковых изделий, если на ней можно однозначно определить их тип и количество.
