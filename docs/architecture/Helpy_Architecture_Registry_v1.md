...
Назначение:
- Этот mini-ТЗ описывает установку нового кондиционера внутри категории Air Conditioning.
- Сценарий «Установка» применяется только для нового кондиционера, который находится на объекте клиента.
- Установка бывших в эксплуатации или ранее демонтированных кондиционеров не входит в MVP.
- Сценарий «Установка» не является ремонтом, переносом, демонтажем или диагностикой кондиционера.
...
- ТЗ формируется через подтверждение нового оборудования, наличие точки установки, примерную мощность кондиционера, тип стены, место размещения наружного блока и фотографии.

#### Вопросы клиенту

1. Кондиционер новый?
- Да, новый.
- Нет, бывший в использовании.
- Не знаю.

Если выбрано «Нет, бывший в использовании» или «Не знаю», система показывает сообщение:
- Helpy поддерживает установку только нового кондиционера. Установка бывших в эксплуатации кондиционеров не входит в MVP.

[Понятно]

2. Есть ли подготовленная точка установки?
- Да.
- Нет.
- Не знаю.

3. Примерная мощность кондиционера:
- 9 000–12 000 BTU.
- 18 000 BTU.
- 24 000 BTU.
- Более 24 000 BTU.
...
5. Где будет размещён наружный блок?
- Балкон.
- На земле.
- На кронштейне.
- Крыша или сложный доступ.
- Не знаю.

#### Правила вопросов

- Вопрос о новом оборудовании является стоп-условием.
- Если кондиционер был в использовании или клиент не уверен, заказ на установку не создаётся в рамках MVP.
- Наличие подготовленной точки установки помогает оценить объём работ, но не гарантирует совместимость.
- Примерная мощность кондиционера используется для оценки сложности установки и возможных дополнительных материалов.
- Тип стены влияет на сложность монтажа и риски крепления.
...
- Материалы, дополнительная длина трассы, кронштейны, дренаж, кабель и работы со сложным доступом согласуются через чат до утверждения финальной цены заказа.

#### Обязательные фотографии

1. Фото места установки внутреннего блока.
- 1 обязательная фотография.

2. Фото места установки наружного блока, если к нему есть безопасный доступ.
- 1 обязательная фотография, если место безопасно доступно для клиента.

3. Фото существующего отверстия, трассы или зоны прокладки коммуникаций, если они есть.
- До 1 дополнительной фотографии.

4. Фото электрической точки, розетки или зоны автомата, если они видны.
- 1 обязательная фотография.

5. Фото шильдика, упаковки или карточки товара с технической информацией.
- 1 обязательная фотография.
...
- Клиент обеспечивает доступ к месту установки внутреннего блока и месту размещения наружного блока, если это безопасно.
- Клиент не обязан выполнять опасные действия для фотографирования места размещения наружного блока.
- Перенос электрической точки, новая проводка, работы с автоматами, строительные работы, ремонт стен и отделочные работы не входят в базовый объём установки.
- Дополнительная длина трассы, кронштейны, дренаж, кабель, расходные материалы и дополнительные материалы согласуются через чат до утверждения финальной цены заказа.
- Платформа не участвует в покупке материалов.

#### Правила выполнения работ мастером

1. Проверка технического задания до отклика:
- Мастер изучает место установки, место размещения наружного блока, примерную мощность кондиционера, тип стены, электрическую точку и техническую информацию оборудования.
- Мастер проверяет совместимость мест установки внутреннего и наружного блока, тип стены, доступ и видимую готовность электроподключения до начала работ.
- Мастер проверяет, что оборудование новое и находится на объекте.

2. Выполнение установки:
- Мастер выполняет установку только в пределах согласованного объёма работ.
- Мастер не выполняет работы на высоте без подходящего оборудования и безопасных условий.
- Мастер не выполняет перенос электрической точки, новую проводку, работы с автоматами, строительные работы, ремонт стен или отделочные работы в рамках базового объёма установки.
- Дополнительная длина трассы, кронштейны, дренаж, кабель, расходные материалы, сложный доступ и дополнительные материалы должны быть согласованы через чат до утверждения финальной цены заказа.
