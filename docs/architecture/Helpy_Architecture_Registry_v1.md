...
2. Новый электрический душ находится на объекте?
- Да.
- Нет.

Если клиент выбирает «Нет», система показывает сообщение:
- Для замены электрического душа требуется наличие нового электрического душа на объекте.
...
- Клиент не обязан понимать технические характеристики электрического душа.
- Клиент не обязан извлекать новый электрический душ из упаковки.
- Клиент не обязан разбирать розетки, автоматы или проводку.
- Клиент не обязан выполнять действия, связанные с электричеством.
- Клиент не обязан производить измерения.
...
1. Проверка нового электрического душа до демонтажа установленного:
- Если работа предполагает замену электрического душа, мастер обязан проверить новый электрический душ до демонтажа установленного.
- Проверка включает совместимость, комплектность, целостность и возможность установки.
