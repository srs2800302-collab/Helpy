...
- Уберите ценные вещи до начала работ.
...
- Вы не обязаны описывать проблему в свободной форме.
- Вы не обязаны самостоятельно классифицировать загрязнения.
...
- Подготовьте доступ к месту выполнения работ.
- Уберите деньги, документы и ценные вещи до начала работ.
- Вы не обязаны описывать проблему в свободной форме.
- Вы не обязаны подготавливать объект полностью без конкретного действия.
...
- Вы не обязаны описывать проблему в свободной форме.
- Вы не обязаны самостоятельно классифицировать строительные загрязнения.
- Эти детали оцениваются по required photos и при необходимости уточняются через чат.
