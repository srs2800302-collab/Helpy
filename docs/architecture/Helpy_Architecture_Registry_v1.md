...
Фотографии — Подключение к вентиляции:

1. Общий вид места установки.
- 1 обязательная фотография.
- До 1 дополнительной фотографии с другого ракурса.

2. Фото кухонной вытяжки в упаковке.
- 1 обязательная фотография.

3. Фото упаковки со всей информацией на ней или карточка приобретённого товара.
- 1 обязательная фотография.
- До 3 дополнительных фотографий.

4. Фото расположения вентиляционного отверстия.
- 1 обязательная фотография.

5. Фото расположения электрической точки.
- 1 обязательная фотография.

Лимит фотографий — Подключение к вентиляции:
- Обязательные: 5 фотографий.
- Дополнительные: до 4 фотографий.
- Всего: до 9 из 10 фотографий.

Фотографии — Без подключения к вентиляции:
...
4. Фото расположения электрической точки.
- 1 обязательная фотография.

Лимит фотографий — Без подключения к вентиляции:
- Обязательные: 4 фотографии.
- Дополнительные: до 4 фотографий.
- Всего: до 8 из 10 фотографий.
...
1. Общий вид установленной кухонной вытяжки.
- 1 обязательная фотография.
- +1 обязательная фотография с другого ракурса.

2. Фото новой кухонной вытяжки в упаковке.
- 1 обязательная фотография.
